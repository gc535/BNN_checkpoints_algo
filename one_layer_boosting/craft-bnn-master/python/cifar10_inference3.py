# Uses +1 padding instead of 0 padding
import sys
import os
import time
...
if __name__ == "__main__":
    ...
    X = test_set.X[test_instances:10000]
    y = test_set.y[test_instances:10000]
    ...
    # Load parameters
    with np.load(params_dir + '/cifar10_parameters_1p.npz') as f:
    ...
    print observe_fn0(X).shape
    print observe_fn1(X).shape
    print observe_fn2(X).shape
    
    observe_target=observe_fn0(X)
    print observe_target[0,0,:,:]
    
    observe_target1=observe_fn1(X)
